...
var (
	...
	HTTPRequestsTotal = promauto.NewCounterVec(
		prometheus.CounterOpts{
			Name: "usbvault_http_requests_total",
	...
	HTTPRequestDuration = promauto.NewHistogramVec(
		prometheus.HistogramOpts{
			Name:    "usbvault_http_request_duration_seconds",
	...
	VaultOpsTotal = promauto.NewCounterVec(
		prometheus.CounterOpts{
			Name: "usbvault_vault_operations_total",
	...
	UploadDuration = promauto.NewHistogram(
		prometheus.HistogramOpts{
			Name:    "usbvault_upload_duration_seconds",
	...
	UploadSizeBytes = promauto.NewHistogram(
		prometheus.HistogramOpts{
			Name:    "usbvault_upload_size_bytes",
	...
	EncryptionDuration = promauto.NewHistogramVec(
		prometheus.HistogramOpts{
			Name:    "usbvault_encryption_duration_seconds",
	...
	RateLimitHitsTotal = promauto.NewCounterVec(
		prometheus.CounterOpts{
			Name: "usbvault_rate_limit_hits_total",
	...
	KeyRotationOpsTotal = promauto.NewCounterVec(
		prometheus.CounterOpts{
			Name: "usbvault_key_rotation_operations_total",
	...
	AuditLogSize = promauto.NewGauge(
		prometheus.GaugeOpts{
			Name: "usbvault_audit_log_entries_total",
	...
	SecurityEventsTotal = promauto.NewCounterVec(
		prometheus.CounterOpts{
			Name: "usbvault_security_events_total",
	...
	WebSocketConnections = promauto.NewGauge(
		prometheus.GaugeOpts{
			Name: "usbvault_websocket_connections_active",
	...
	WebSocketMessagesTotal = promauto.NewCounterVec(
		prometheus.CounterOpts{
			Name: "usbvault_websocket_messages_total",
	...
	AuthAttemptsTotal = promauto.NewCounterVec(
		prometheus.CounterOpts{
			Name: "usbvault_auth_attempts_total",
	...
	CircuitBreakerState = promauto.NewGaugeVec(
		prometheus.GaugeOpts{
			Name: "usbvault_circuit_breaker_state",
	...
	ActiveSubscriptions = promauto.NewGaugeVec(
		prometheus.GaugeOpts{
			Name: "usbvault_active_subscriptions",
