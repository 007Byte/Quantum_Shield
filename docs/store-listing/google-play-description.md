...
Portable encrypted file vault with zero-trace forensic cleaning. Carry. Access. Gone.
...
Built for professionals who handle sensitive information and individuals who believe their private files should stay private.
...
AES-256-GCM-SIV — A secondary encryption layer providing misuse-resistant authenticated encryption.
...
- Recent file and jump list scrubbing
- Memory page wiping
- Thumbnail cache destruction
...
Support for FIDO2 and WebAuthn hardware security keys (YubiKey and compatible devices). Add a physical second factor so that your vault cannot be opened without the key in hand — even if your password is compromised.

------

PASSWORD MANAGER

Store all your credentials inside the same encrypted vault. Generate strong passwords, organize entries by category, and search instantly. Your password database travels with your vault and benefits from the same encryption and zero-trace protections.
...
DISASTER RECOVERY WITH SHAMIR'S SECRET SHARING

Split your vault recovery key into multiple fragments and distribute them to trusted people. No single fragment can unlock your vault. Combine the required number of fragments to restore access. Lose your password without recovery fragments and your data is permanently inaccessible — by design.

------

SUBSCRIPTION TIERS

Free — 1 vault, 100 MB. Full encryption. No ads. No tracking.
Individual — 5 vaults, 10 GB.
Team — 50 vaults, 100 GB. Shared vault management.
Enterprise — Unlimited vaults, 1 TB. Admin console, audit logging, SSO.

------

AVAILABLE IN 4 LANGUAGES

English, Spanish, French, and German. Additional languages planned.

------

PRIVACY PRINCIPLES

- No cloud key storage — encryption keys exist only on your device
