...
echo "=== USBVault Backup Key Rotation ==="
...
echo "   aws secretsmanager create-secret --name 'usbvault/backup-encryption-key' \\"
echo "     --secret-string '$NEW_KEY'"
echo ""
echo "2. HashiCorp Vault:"
echo "   vault kv put secret/usbvault/backup encryption_key='$NEW_KEY'"
echo ""
...
echo "   for backup in /var/backups/usbvault/*.sql.gz.enc; do"
...
echo "   rm -f /var/backups/usbvault/*.sql.gz.enc"
echo ""
