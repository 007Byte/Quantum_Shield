...
describe('PasswordStep', () => {
  ...
  it('fires onChangePasswordConfirm when the confirm input changes', () => {
    ...
    fireEvent.changeText(getByLabelText('setupUsb.confirmMasterPassword'), 'Tr0ub4dour-Vault!');
  ...
  it('fires onToggleShowPassword when the master eye button is pressed', () => {
    ...
    const { getAllByRole } = render(<PasswordStep {...buildProps({ onToggleShowPassword })} />);
