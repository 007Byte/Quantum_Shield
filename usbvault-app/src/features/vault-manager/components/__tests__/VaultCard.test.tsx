...
describe('VaultCard', () => {
  ...
  it('shows the active indicator when isActive is true', () => {
    const { getByText } = render(<VaultCard vault={makeVault()} isActive {...makeActions()} />);
  ...
  it('renders the High security badge label', () => {
    const { getByText } = render(
      <VaultCard vault={makeVault({ securityLevel: 'high' })} isActive={false} {...makeActions()} />
    );
  ...
  it('fires onOpen with the vault id', () => {
    ...
    const { getByText } = render(<VaultCard vault={makeVault()} isActive={false} {...actions} />);
