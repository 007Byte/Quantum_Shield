...
describe('ScanPanel', () => {
  it('renders the page title and subtitle', () => {
    ...
    expect(getByText('Eliminate forensic evidence across three tiers of cleanup')).toBeTruthy();
  ...
  it('renders a fully-successful cleanup summary with all details', () => {
    ...
    const { getByText } = render(<ScanPanel {...baseProps} cleanupSummary={cleanupSummary} />);
